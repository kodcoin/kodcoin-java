...
import org.kodj.crypto.DeterministicKey;
import org.kodj.crypto.LazyECPoint;
import org.kodj.crypto.MnemonicCode;
import org.kodj.crypto.MnemonicException;
import org.kodj.net.discovery.PeerDiscovery;
import org.kodj.net.discovery.PeerDiscoveryException;
...
import org.kodj.script.ScriptChunk;
import org.kodj.script.ScriptOpCodes;
import org.kodj.store.BlockStore;
import org.kodj.store.BlockStoreException;
import org.kodj.store.LevelDBBlockStore;
import org.kodj.utils.BriefLogFormatter;
import org.kodj.wallet.*;
...
public class MatiTest {
    ...
    public void accountDetailsTest(){
        ...
        Wallet wallet = Wallet.fromSeed(
                networkParameters,
                seed,
                DeterministicKeyChain.KeyChainType.BIP44_KOD_ONLY
        );
    ...
    public Wallet restore(NetworkParameters networkParameters) throws IOException {
        String filename = "2.0.32_kod-wallet-backup_org.kod.production-2017-11-20";
        //"1.01_kod-wallet-backup_org.kod.production-2017-07-26 (2)";
    ...
    public void watchOnlyTest(){
        ...
        Wallet watchingWallet = Wallet.fromWatchingKeyB58(networkParameters,xpub,0, DeterministicKeyChain.KeyChainType.BIP44_KOD_ONLY);
