...
import org.kodj.core.listeners.TransactionConfidenceEventListener;
import org.kodj.core.AbstractBlockChain;
import org.kodj.core.Address;
import org.kodj.core.Block;
import org.kodj.core.BlockChain;
import org.kodj.core.Coin;
import org.kodj.core.ECKey;
import org.kodj.core.InsufficientMoneyException;
import org.kodj.core.PeerAddress;
import org.kodj.core.Sha256Hash;
import org.kodj.core.StoredBlock;
import org.kodj.core.Transaction;
import org.kodj.core.TransactionConfidence;
import org.kodj.core.TransactionInput;
import org.kodj.core.TransactionOutPoint;
import org.kodj.core.TransactionOutput;
import org.kodj.core.Utils;
import org.kodj.core.VerificationException;
import org.kodj.core.TransactionConfidence.ConfidenceType;
import org.kodj.crypto.*;
import org.kodj.script.Script;
import org.kodj.script.ScriptBuilder;
import org.kodj.signers.StatelessTransactionSigner;
import org.kodj.signers.TransactionSigner;
import org.kodj.store.BlockStoreException;
import org.kodj.store.MemoryBlockStore;
import org.kodj.testing.*;
import org.kodj.utils.ExchangeRate;
import org.kodj.utils.Fiat;
import org.kodj.utils.Threading;
import org.kodj.wallet.Wallet.BalanceType;
import org.kodj.wallet.WalletTransaction.Pool;
...
import org.kodj.wallet.Protos.Wallet.EncryptionType;
...
import static org.kodj.core.Coin.*;
import static org.kodj.core.Utils.HEX;
import static org.kodj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: kodj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("kodj-unit-test", null);
