...
import static org.kodj.core.Coin.CENT;
import static org.kodj.core.Coin.COIN;
import static org.kodj.core.Coin.SATOSHI;
import static org.kodj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    public void btcRounding() throws Exception {
        ...
        assertEquals("1.00000005", format(kodot, 0, 8));
        assertEquals("1.00000005", format(kodot, 0, 7, 1));
        assertEquals("1.0000001", format(kodot, 0, 7));
    ...
    public void mBtcRounding() throws Exception {
        ...
        final Coin kodot = COIN.add(SATOSHI.multiply(50));
        assertEquals("1000.0005", format(kodot, 3, 4));
        assertEquals("1000.0005", format(kodot, 3, 3, 1));
        assertEquals("1000.001", format(kodot, 3, 3));
    ...
    public void uBtcRounding() throws Exception {
        ...
        final Coin kodot = COIN.add(SATOSHI.multiply(5));
        assertEquals("1000000.05", format(kodot, 6, 2));
        assertEquals("1000000.05", format(kodot, 6, 0, 2));
        assertEquals("1000000.1", format(kodot, 6, 1));
        assertEquals("1000000.1", format(kodot, 6, 0, 1));
