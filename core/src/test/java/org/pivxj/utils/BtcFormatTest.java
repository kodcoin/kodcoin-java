...
import static org.kodj.core.NetworkParameters.MAX_MONEY;
import static org.kodj.utils.BtcAutoFormat.Style.CODE;
import static org.kodj.utils.BtcAutoFormat.Style.SYMBOL;
import static org.kodj.utils.BtcFixedFormat.REPEATING_DOUBLETS;
import static org.kodj.utils.BtcFixedFormat.REPEATING_TRIPLETS;
...
public class BtcFormatTest {
    ...
    public void btcRounding() throws Exception {
        ...
        final Coin kodot = COIN.add(SATOSHI.multiply(5));
        assertEquals("1.00000005", BtcFormat.getCoinInstance(US, 8).format(kodot));
        assertEquals("1.00000005", coinFormat.format(kodot, 8));
        assertEquals("1.00000005", BtcFormat.getCoinInstance(US, 7, 1).format(kodot));
        assertEquals("1.00000005", coinFormat.format(kodot, 7, 1));
        assertEquals("1.0000001", BtcFormat.getCoinInstance(US, 7).format(kodot));
        assertEquals("1.0000001", coinFormat.format(kodot, 7));
