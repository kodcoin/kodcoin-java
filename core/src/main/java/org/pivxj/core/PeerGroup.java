...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of kodj fixes the known
     ...
     * {@link org.kodj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.kodj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.kodj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.kodj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.kodj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.kodj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.kodj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.kodj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.kodj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a kodj based app running in SPV mode to fully validating security.
     */
