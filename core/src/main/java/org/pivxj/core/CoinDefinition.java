...
public class CoinDefinition {
    ...
    public static final String coinTicker = "KOD";
    public static final String coinURIScheme = "kod";
    public static final String cryptsyMarketId = "155";
    public static final String cryptsyMarketCurrency = "KOD";
    ...
    static public String[] dnsSeeds = new String[] {
            "kod.seed.fuzzbawls.pw",
            "kod.seed2.fuzzbawls.pw",
            "coin-server.com",
            "s3v3nh4cks.ddns.net"
    };
    ...
    static public String[] testnetDnsSeeds = new String[] {
            "kod-testnet.seed.fuzzbawls.pw",
            "kod-testnet.seed2.fuzzbawls.pw",
            "s3v3nh4cks.ddns.net"
    };
    ...
    public static final String ID_MAINNET = "org.kod.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.kod.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.kod.unittest";
