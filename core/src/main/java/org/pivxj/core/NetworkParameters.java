...
import org.kodj.net.discovery.HttpDiscovery;
import org.kodj.params.*;
...
import org.kodj.utils.MonetaryFormat;
...
import org.kodj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.kod.regtest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.kodj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.kodj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.kodj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.kodj.core.AlertMessage}s. You can use {@link org.kodj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
