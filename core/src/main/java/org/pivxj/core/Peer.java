...
import org.kodj.net.StreamConnection;
import org.kodj.store.BlockStore;
import org.kodj.store.BlockStoreException;
import org.kodj.utils.ListenerRegistration;
 ...
 * {@link org.kodj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.kodj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.kodj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.kodj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.kodj.core.TxConfidenceTable}
    ...
    protected void processMessage(Message m) throws Exception {
        ...
        else if(m instanceof SporkMessage)
        {
            ...
            // todo furszy: check kod masternodes
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // kodj is a client mode implementation. That means there's not much point in us talking to other client
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.kodj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.kodj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.kodj.core.Peer#ping()} has never
