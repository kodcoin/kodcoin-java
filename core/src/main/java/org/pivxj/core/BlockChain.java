...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.kodj.store.SPVBlockStore} or you could also try a
     * {@link org.kodj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
