...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.kodj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.kodj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.kodj.crypto.KeyCrypter,
