...
import org.kodj.core.*;
import org.kodj.core.Message;
import org.kodj.core.listeners.*;
import org.kodj.core.TransactionConfidence.*;
import org.kodj.crypto.*;
import org.kodj.script.*;
import org.kodj.signers.*;
import org.kodj.utils.*;
import org.kodj.wallet.Protos.Wallet.*;
import org.kodj.wallet.WalletTransaction.*;
import org.kodj.wallet.listeners.KeyChainEventListener;
import org.kodj.wallet.listeners.ScriptsChangeEventListener;
import org.kodj.wallet.listeners.WalletChangeEventListener;
import org.kodj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.kodj.wallet.listeners.WalletCoinsSentEventListener;
import org.kodj.wallet.listeners.WalletEventListener;
import org.kodj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.kodj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_KOD_ONLY? 1 : 0;
     ...
     * {@link org.kodj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.kodj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.kodj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.kodj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.kodj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.kodj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.kodj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.kodj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.kodj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.kodj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.kodj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.kodj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.kodj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of kodj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.kodj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.kodj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.kodj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.kodj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.kodj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.kodj.crypto.KeyCrypter,
     ...
     * {@link org.kodj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.kodj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.kodj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.kodj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.kodj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.kodj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
