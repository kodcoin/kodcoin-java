...
import org.kodj.wallet.KeyChain.KeyPurpose;
import org.kodj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.kodj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.kodj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
