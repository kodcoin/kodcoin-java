...
/**
 * <p>A KeyChainGroup is used by the {@link org.kodj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.kodj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.kodj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.kodj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
